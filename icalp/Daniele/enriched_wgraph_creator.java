            ...
            try {
                ...
                if(i==0){
                    ...
                    while((line = f2.readLine()) != null) {
                        ...
                        max_vertex=Math.max(max_vertex,Math.max(Integer.valueOf(arr_line[0]),Integer.valueOf(arr_line[1])));
                    ...
                    f2.close();
                    newGraphWeighted.println("LightGraphs.SimpleWeightedGraph,"+String.valueOf(max_vertex)+","+String.valueOf(sizef2)+",u,graph,1,Int64,Float64,simpleweightedgraph");
                    newGraph.println(String.valueOf(max_vertex)+","+String.valueOf(sizef2)+",u,graph,2,Int64,simplegraph");
                ...
                FileReader fr2= new FileReader("./graphs/icalpw/icalpwEdges"+ String.valueOf(arr[i]) +".txt");
                BufferedReader f2 = new BufferedReader(fr2);
                String[] header=f1.readLine().split(",");
                Integer sizef1 =Integer.parseInt(header[2]);
                max_vertex=Integer.parseInt(header[1]);
                Integer sizef2=0;
                ...
                f2.close();
                newGraphWeighted.println("LightGraphs.SimpleWeightedGraph,"+String.valueOf(max_vertex)+","+String.valueOf(sizef1+sizef2)+",u,graph,1,Int64,Float64,simpleweightedgraph");
                newGraph.println(String.valueOf(max_vertex)+","+String.valueOf(sizef1+sizef2)+",u,graph,2,Int64,simplegraph");
                for (Map.Entry<String, Integer> entry : temp_map.entrySet()) {
                    String key = entry.getKey();
                    Integer value = entry.getValue();
                    newGraphWeighted.println(key+","+String.valueOf(value));
