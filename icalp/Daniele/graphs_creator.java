        ...
        try {
            ...
            for (Map.Entry<String, Integer> entry : map.entrySet()) {
                ...
                if (Integer.parseInt(line_temp[2])<= arr[i]){
                    max_vertex=Math.max(max_vertex,Math.max(Integer.valueOf(line_temp[0]),Integer.valueOf(line_temp[1])));
            ...
            out1.println(String.valueOf(max_vertex)+","+String.valueOf(num_line)+",u,graph,2,Int64,simplegraph");
            out2.println("LightGraphs.SimpleWeightedGraph,"+String.valueOf(max_vertex)+","+String.valueOf(num_line)+",u,graph,1,Int64,Float64,simpleweightedgraph");
